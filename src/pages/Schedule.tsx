        ...
        <div className={styles.schedulerLayout}>
          <div className={styles.retancle}>
            <div className={styles.header}>
              ...
              <p id={styles.subtitles}>
                Visualize e gerencie todas as suas agendas
              </p>
            </div>
            <div className={styles.new}>+ Nova agenda</div>
          </div>
        </div>
        ...
        <div className={styles.mainContent}>
          <div className={styles.calendar}>
            ...
            <div className={styles.filter}>
              ...
              <div className={styles.buttons}>
                <button className={styles.button}>Todas as agendas</button>
                <button className={styles.button}>
                  Todos os profissionais
                </button>
                <button className={styles.button}>Todos os serviços</button>
                <button className={styles.button} id={styles.cls}>
                  Limpar filtros
                </button>
              </div>
            </div>
          ...
          <div className={styles.hours}>
            <div className={styles.today}>
              <p id={styles.textday}>{today.day},{today.dayN} de {today.mon}</p>
              <p id={styles.subtitleDay}>(Onde ficará o dia atual.)</p>
            </div>
            <div className={styles.schedule}>
              <div className={styles.container}>
                Onde ficará o agendamento já criado!
              </div>
            </div>
          </div>
